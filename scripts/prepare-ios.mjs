...
if (!html.includes('Menú del juego') || !html.includes('Crear una sopa') || !html.includes('journey') || !html.includes('viewport')) throw Error('Bundled HTML must contain the rendered game and mobile viewport');
